            ...
            <div class="col-md-12 alert alert-warning" role="alert">
              ...
              <div>
                <ul>
                  ...
                  <li>
                    ครูแกนนำในโรงเรียน<u>ขนาดเล็ก</u>และ<u>ขนาดกลาง</u>ทุกโรงเรียน จำนวน <strong>1</strong> ท่านต่อโรงเรียน (ให้เลือกจากครูในกลุ่ม 8 สาระ)
                  </li>
                  <li>
                    ครูแกนนำในโรงเรียน<u>ขนาดใหญ่</u>ทุกโรงเรียน จำนวน <strong>1-2</strong> ท่านต่อโรงเรียน (ให้เลือกจากครูในกลุ่ม 8 สาระ)
                  </li>
                </ul>
                <hr>
                <ul>
