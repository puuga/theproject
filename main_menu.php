            ...
            <div class="col-md-12 alert alert-warning" role="alert">
              ...
              <div>
                <ul>
                  ...
                  <li>
                    ผู้อำนวยการโรงเรียนทุกโรงเรียนในเขตพื้นที่ที่รับผิดชอบ ตามที่เขตพื้นที่กำหนด
                  </li>
                  <li>
                    ครูแกนนำในโรงเรียน<!--<u>ขนาดเล็ก</u>และ--><u>ขนาดกลาง</u>ทุกโรงเรียน จำนวน <strong>1</strong> ท่านต่อโรงเรียน (ให้เลือกจากครูใน 8 กลุ่มสาระ) ตามที่เขตพื้นที่กำหนด
                  </li>
                  <li>
                    ครูแกนนำในโรงเรียน<u>ขนาดใหญ่</u>ทุกโรงเรียน จำนวน <strong>1-2</strong> ท่านต่อโรงเรียน (ให้เลือกจากครูใน 8 กลุ่มสาระ) ตามที่เขตพื้นที่กำหนด
                  </li>
                </ul>
                <hr>
                <ul>
