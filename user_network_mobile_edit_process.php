<?php //user_network_mobile_edit_process.php ?>
<?php
...
if ( $key=="admin_level") {
  $key2 = $_POST["key2"];
  $val2 = $_POST["val2"];
  $sql = "UPDATE user_network_mobile SET $key = '$val', $key2 = '$val2' WHERE id = $user_id;";
}
else {
  $sql = "UPDATE user_network_mobile SET user_network_mobile.$key = '$val' WHERE id = $user_id;";
}
